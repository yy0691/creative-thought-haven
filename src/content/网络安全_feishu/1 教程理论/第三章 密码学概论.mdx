...
1. <InfoText>**分组密码**</InfoText><InfoText>是每次只能处理特定长度的一块数据的一类密码算法，这里的“一块”就称为</InfoText><InfoText>**分组**</InfoText><InfoText>。一个分组的比特数就称为</InfoText><InfoText>**分组长度**</InfoText>。最新一代分组密码长度为128位，加密128位明文产生128位密文。分组密码是可逆的，<span style={{"color": "#C0ECBC"}}>明文和密文的长度被称为分组长度</span>。
...
4. <span style={{"color": "#D4C1F3"}}>**常用的工作模式包括：**</span>
    ...
    * <InfoText>CTR模式：CounTER mode 计数器模式</InfoText>
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/ARcZbWX2ToOPkGxZO3WcoG6NnDb.png)

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/Sm3jbDdJUo9Ym8xqd6GcoKy1nSg.png)

#### CBC模式

<InfoText>CBC模式中，</InfoText><span style={{"color": "#C0ECBC"}}>首先将明文分组与</span><span style={{"color": "#C0ECBC"}}>**前一个密文分组**</span><u><span style={{"color": "#C0ECBC"}}>进行XOR运算</span></u><span style={{"color": "#C0ECBC"}}>，然后再进行加密。</span>

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/MHTFbgVljohw1Ix7LMDcwObrnGc.png)

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/BfVxbQoAUoeVnkx0b6uc70Tfnmd.png)

#### CFB模式

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/A8kPblOJ7otp1gxrn8DcAAxYnKg.png)

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/ANefbwLD9oLjptxioqMc9GJSnqg.png)
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/N5OYb5ljuozrNHxEnsXcNiW8nIg.png)

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/KmkEbWKbOoR2VWxMLCEcbsgxnRh.png)



![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/NTWTbfD0eocv0XxNRhHcpxylnDg.png)
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/A7yxbxplsoXEV3xU6wEcindAn7e.png)

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/Jry3bpU6OoCC1FxS3Xxc0T2Bnac.png)

计数器的生成方法，前8个字节为<u>nonce</u>，这个值在每次加密时必须时不同的。后8个字节为分组序号，这个部分逐次累加。

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/N3gcbUer4oPoRCxjJ8UcakSEnbe.png)
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/FlTLbsBECovM6ux31r7cwwWdnlb.png)
...
* <mark style={{"backgroundColor": "#C0ECBC"}}>常见：</mark><mark style={{"backgroundColor": "#C0ECBC"}}>**DES（已被AES取代）、IDEA、AES**</mark>

## 公钥密码体制（非对称密码体制）

* 原理：在加密和解密的过程中使用不同的密钥处理方式，其中，加密密钥可以公开，而只需要把解密密钥安全存放即可。

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/Ag6abaLx4oXzG5xX1j1cooTrn9N.png)

* 优点：
  * 钥分发方便，能以公开方式分配加密密钥
  * 密钥保管量少
  * 支持数字签名
* <mark style={{"backgroundColor": "#C0ECBC"}}>常见：</mark><mark style={{"backgroundColor": "#C0ECBC"}}>**RSA体制、ELGamal体制、椭圆曲线密码体制**</mark>

## 混合密码体制

* 制利用公钥密码体制分配私钥密码体制的密钥，消息的收发双方共用这个密钥，然后按照私钥密码体制的方式，进行加密和解密运算。

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/SEiLbiGXvoqByGxPhCNcJ8shngh.png)
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/CWXCbkQ4wosdhFxjfSachJQ9nRd.png)

### 加密流程

<InfoText>（1）输入64位明文数据，并进行初始置换IP；</InfoText>

<InfoText>（2）在初始置换IP后，明文数据再被分为左右两部分，每部分32位，以L0，R0表示；</InfoText>

<InfoText>（3）在秘钥的控制下，经过16轮运算(f)；</InfoText>

<InfoText>（4）16轮后，左、右两部分交换，并连接再一起，再进行逆置换；</InfoText>

<InfoText>（5）输出64位密文</InfoText>

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/JuT7bPhygoMLBixxSmrcKJxsnib.png)

<InfoText>输入的64位明文的第1位置换到第40位，第2位置换到第8位，第3位置换到第48位。以此类推，最后一位是原来的第7位。置换规则是规定的。L0(Left)是置换后的数据的前32位，R0(Right)是置换后的数据的后32位</InfoText>
...
<InfoText>Ln = R(n - 1)；</InfoText>

<InfoText>Rn = L(n - 1)⊕f(Rn-1,kn-1)</InfoText>

<InfoText>⊕:异或运算</InfoText>

<InfoText>Kn是向第N层输入的48位的密钥，f是以Rn-1和Kn为变量的输出32位的函数</InfoText>

<InfoText><mark style={{"backgroundColor": "#C0ECBC"}}>函数f由四步运算构成：</mark></InfoText><InfoText><mark style={{"backgroundColor": "#C0ECBC"}}>**密钥置换(Kn的生成，n=0~16)；扩展置换；S-盒代替；P-盒置换**</mark></InfoText><InfoText>。</InfoText>
...
1. <InfoText>**密钥置换选择1--PC-1(子密钥的生成)**</InfoText>
    * 原来64位的密钥K中的奇偶校验位将被<u>删去</u>
    * 剩余的56位打乱重排（按PC-1置换的置换表，同理）
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/IsTzbYZ0Bok5awxwIdqcKxxonyb.png)

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/VCiibANmCo75SoxPzc7cn2UxnVh.png)
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/BlmQbibcCojGCtx76VKcLKwRnCe.png)

## 国产密码算法

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/P6COb4Elloyn82xKXD4cfUXsnDf.png)
...
<mark style={{"backgroundColor": "#F2F3F5"}}>Hash算法，又称杂凑算法、散列算法、哈希算法或数据摘要算法</mark>
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/P5aRb2KKvoSp9tx1kWGcmx5hnpe.png)

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/F9lMb92dsosf8oxO9b0cq817nbd.png)
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/W6hibjzLYo2IUGxtAbmcNbtinph.png)
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/AazlbaOGJoeXXSxEL6XcrtQ7nuh.png)

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/NZhEbOmC4oTtrnx3RMtc7QxInth.png)
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/TUuHb6n9hocWAQxPDDxcNW6WnMg.png)
