...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/CdsObjuQko0G3gxUSfzceNWYnJe.png)
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/PiU8bkgZroeJGAxxWl3cW8Uunid.png)

### 基于挑战响应

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/XOilbgSJcokRlixJjgQcLlw4nJg.png)
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/YlwPbN7o0oLr6OxI1ekc1JxMnnb.png)
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/Ycehb0MC0oVRFCxszQhc9O8SnOc.png)
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/FMNUbDFrNoG7VPxxsStc5EtGnrd.png)

1. 申请票据

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/W9Gdb6q8ooH0l2xCcuNchsfHnyg.png)

1. AS收到消息后，AS在认证数据库检查确认kerberos客户，产生一个会话密钥，同时使用客户的秘密密钥对会话密钥进行加密，然后生成一个票据TGT，中TGT由Kerberos客户的实体名、地址、时间戳、限制时间、会话密钥组成。

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/ZJYTbToQGo9FHnxR76lcsvu1nKg.png)

1. 客户收到TGT后，用自己的秘密密钥解密得到会话密钥，然后利用解密的信息重新构造认证请求单，向TGS发送请求，申请访问应用服务器AP所需要的票据

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/Oxqebr3lXoVTwYxsti3cvK9fnSc.png)

1. TGS使用其秘密密钥对TGT解密，同时使用TGT中的会话密钥对客户的请求认证单进行解密，并将解密后的认证单信息和TGT中的信息进行比较。然后TGS生成新的会话密钥以供客户和服务器使用，并利用各自的秘密密钥加密会话密钥。最后，生成一个票据。

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/Em4SbFcCVoogAmxpSRrciJzanVg.png)

1. 客户收到TGS的响应后，获得与AP共享的会话密钥，同时，客户生成一个新的用于访问AP的认证单，并用该会话密钥加密，然后与TGS发来的票据一起发送到AP。

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/VUo7bcArxoC7xWx5zmYctiBCnth.png)
