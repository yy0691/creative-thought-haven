...
> <mark style={{"backgroundColor": "#F2F3F5"}}>建立逻辑连接、进行硬件地址寻址、差错校验 [3] 等功能。（由底层网络定义协议）将比特组合成字节进而组合成帧，用MAC地址访问介质，错误发现但不能纠正。物理寻址、同时将原始比特流转变为逻辑传输线路</mark><mark style={{"backgroundColor": "#F2F3F5"}}>**地址解析协议**</mark><mark style={{"backgroundColor": "#F2F3F5"}}>：ARP、PARP（反向地址转换协议）</mark>
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/KVyFboBBTojBCRxczO6cyJU9nme.png)
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/Z7bmb8JUWouBKWxZ2vXcw0ANndh.png)
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/JBArb9c3MosMnZxCHTuclZMRndc.png)
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/JcDPbD5UUoc5KnxIT8RcnjSFnZf.png)
