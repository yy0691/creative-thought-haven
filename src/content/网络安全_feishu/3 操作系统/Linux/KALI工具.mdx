...
host指令查询域名信息的DNS服务器即<u><span style={{"color": "#C7D5F6"}}><mark style={{"backgroundColor": "#C7D5F6"}}>/etc/</mark></span></u><u><span style={{"color": "#C7D5F6"}}><mark style={{"backgroundColor": "#C7D5F6"}}>resolv.com</mark></span></u>指定的DNS服务器，若想查询其他DNS服务器，可在指令的尾部直接添加DNS服务器
