...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/FsEDb3djvobJbrxToLpcBUGznoV.png)
...
<span style={{"color": "#C0ECBC"}}><mark style={{"backgroundColor": "#C0ECBC"}}>；表示SQL语句结束  --之后内容为注释</mark></span>
