...
* Find 命令
  ...
  * 查找所有用户可写文件夹
    ...
    * `find / -perm -o w -type d 2>/dev/null`
    ![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/RoLKbn6rvoD8lxxOkRacfB0OnQf.png)
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/CQgsbyXzuoNx8ExC94Vc5qr1nEh.png)
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/VRgBbO2TvoceopxAoIHc01Zente.png)
...
2. 添加一个具有root权限的新用户
    ...
    ![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/XD3jb6gdDoIZH9xVjj2cD7FQnuf.png)

    3. 然后，将这个密码和用户名添加到 `/etc/passwd`  文件
    ![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/KSyIbepz1oAKudx68yQcwMV7nOf.png)

    5. 添加后，需要切换至此用户并希望拥有root权限，注意 `root:/bin/bash` 是如何使用的
    ![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/ErCsbfcNqoF5zyxHYdlcY62onkb.png)
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/W9aAblu9UouXzZx0Yc4c4vXvnWb.png)

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/KUCsb2Oypoww8PxI8S3c9qj9n4g.png)
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/AdhlbD9GZotfYoxr1vdcF3qVnud.png)

在攻击机器上运行一个监听器来接收传入的连接：

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/JxfRbRij1o4K67xmvDicvw49nJg.png)

以下场景在网络安全性不够成熟的公司中很常见：系统管理员需要定期运行一个脚本，然后创建了一个cron任务来完成这项工作，过一段时间，脚本没用了，然后删除脚本，但是没有清理相关的cron工作。



![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/BodUb0pIyoJzU7xyEfrcrhaAnkf.png)
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/H1aqbjVXQoEs0MxwxmjcJiWPnUe.png)

传入的反向shell连接具有root权限:

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/Pq5bbjR7YoU6rfx6KeFcrxU7nOE.png)
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/DerNb0FoPovJ3gxHqwwcsxRYn1c.png)

这个脚本试图启动一个名为“thm”的系统二进制文件，但是 示例可以很容易地用任何二进制文件复制。

编译为可执行文件并设置suid位

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/GDibbenCXoxlZWxtkjfcZujGnsf.png)
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/XlnIboTQSo4MynxZAlqcir3Fnsh.png)

它与 PATH 比较将帮助我们找到可以使用的文件夹。

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/Vxtbbfe83orY64xb3rZcOdIjnif.png)

使用命令在/usr文件夹下搜索

`find / -writable 2>/dev/null | cut -d "/" -f 2,3 | grep -v proc | sort -u` 但是 /usr下的子文件夹不可写

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/JcNfbxajBorPYrx7sFgchWj9nIh.png)

 更容易写入的文件夹可能是/tmp，。因为/tmp是 PATH中不存在，所以我们需要添加它。正如我们在下面看到的， 使用“ `export PATH=/tmp:$PATH` ”命令可以完成此操作。

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/IxLxb9joYo76pDx5U1VcoGI0nue.png)

此时，path脚本也将在/tmp文件夹下查找名为“thm”的可执行文件，只需将/bin/bash复制到/ tmp文件夹的“thm” 

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/T2QsbEOUVoKdF2x6qgfcaJDFnPd.png)

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/LmYKbXJPeo77LKxclr6cq8Kunvf.png)
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/LjIybt9ggo6woOxYXDqcvkvXnjh.png)
...
![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/GPU0bmS0AoYUuCxRIaZcEXFknLb.png)

1. 挂载一个“no_root_squash”共享到我们的攻击中 机器并开始构建我们的可执行文件。

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/SAXzb91aVogzXqx1zg9cd4FtnEd.png)

因为我们可以设置SUID位，一个简单的可执行文件，将运行/bin/bash 将在目标系统上完成这项工作。

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/SdVLbBRE2odS8uxtur8cEOoxnHe.png)

一旦我们编译代码，我们将设置SUID位。

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/UEVZbmaSDohnQ9xcmosc1G9Wnce.png)

在下面可以看到两个文件(nfs.c和nfs在 目标系统。我们已经在挂载共享上工作了，所以不需要转移)。

![](https://raw.githubusercontent.com/yy0691/img-bed/main/Net_Safe_FeiShu/BVPzbUwlzo00StxdpxicNugynac.png)
