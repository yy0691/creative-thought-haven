...
* **Multi-head Attention**：现在通常都用这种Attention，因为相关性不止一种，使用这种Attention可以计算多组关联性，通常有16组
  ...
  ![Multi-Head Attention](images/image-8.png)
...
![Masked Self-Attention](images/image-24.png)
