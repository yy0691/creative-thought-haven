...
<span style="color: #F9D8B1"><mark style="background-color: #FAF390">**表号：1-99**</mark></span>特点：只能基于源IP对包进行过滤
...
<span style="color: #F9D8B1"><mark style="background-color: #FAF390">**表号：100-199**</mark></span>特点：可以基于源IP、目标IP、端口号、协议等对包进行过滤
...
![](assets/Dw26bqdoUood7cxKH7Qcmw9NnGe.png)
