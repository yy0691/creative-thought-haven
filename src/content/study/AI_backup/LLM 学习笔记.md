...
<span style="color: #E0E1E4"><mark style="background-color: #F2F3F5">还记得交叉熵损失函数吗？它就是模型理应输出 1 的那一维向量的元素的负对数。</mark></span>
...
![](assets/Tj8lb1LtuofoilxfcX1c4dSxn9c.png)
...
![](assets/TtsRbgxImob5oyx0tnWcpl1snpe.png)
